...
public class EmailUtil {
    ...
    public static String myEmailAccount = "ctrl_i@zekdot.com";
    public static String myEmailPassword = ConfigConstant.emailPassword;
    ...
    public static void send(String email, String link) throws Exception {
